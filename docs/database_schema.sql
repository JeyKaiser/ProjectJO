...
CREATE TYPE jo.consumo_tipo_tela AS ENUM (
    'SOLIDO','MOD_ARTE','UBI_TRAZO','CUERO','ALL_OVER'
);
...
CREATE TABLE jo.consumos (
    ...
    veces_trazadas       INTEGER,
    cantidad_piezas      INTEGER,
    trazo_id             INTEGER REFERENCES jo.trazos(id) ON DELETE SET NULL,
...
--     Cada trazo = una opcion de tipo_tela por fase (costeo/contramuestra).
--     Referencia: rolesJO/trazador.md
-- ===========================================================================

CREATE TABLE jo.trazos (
    id                   SERIAL PRIMARY KEY,
    reference_id         INTEGER NOT NULL REFERENCES jo.references(id) ON DELETE CASCADE,
...
CREATE INDEX idx_trazos_fase ON jo.trazos(reference_id, fase);
CREATE INDEX idx_trazos_trazador ON jo.trazos(trazador_id);

-- ===========================================================================
-- 8c. *** NUEVO: COMPARATIVO DE TRAZOS ***
--     Comparacion estructurada costeo vs contramuestra.
--     7 dimensiones con justificacion por cada diferencia.
--     Referencia: rolesJO/trazador.md punto 2.2.8.2
-- ===========================================================================

CREATE TABLE jo.comparativo_trazos (
    id                     SERIAL PRIMARY KEY,
    reference_id           INTEGER NOT NULL REFERENCES jo.references(id) ON DELETE CASCADE,
...
CREATE INDEX idx_comparativo_reference ON jo.comparativo_trazos(reference_id);
